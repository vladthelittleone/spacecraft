...
{
    public static final String SOURCE_CODE_URI_TEMPLATE = "string:///%s%s";
    public static final String CLASS_CODE_URI_TEMPLATE = "bytecode:///%s%s";
    ...
    {
        String extension = "";
        String template = location.getName().toLowerCase().replace("_", "")
                + ":///%s%s";
     ...
     * @return URI
     */
    public static URI buildUri(JavaFileManager.Location location,
                               String packageName, String simpleClassName)
    {
