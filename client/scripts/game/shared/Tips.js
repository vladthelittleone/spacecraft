...
},
{
	title: 'Текущая стадия',
		description
:
	'<p>Текущий функционал далек от совершенства (сейчас перед вами первый прототип), но мы упорно работаем над проектом и надеемся реализовать все наши идеи и задумки.</p>'
...
,
{
	title: 'Мини-игра',
		description
:
	'<p>Какая же основная задача этой игры?</p>'
	+ '<div class="img-medium-center">'
...
,
{
	title: 'Редактор кода',
		description
:
	'<p>Редактор кода находится в правой части.</p>'
	+ '<div class="img-medium-center">'
...
,
{
	title: 'Документация',
		description
:
	'<p>Документация содержит информацию о всех функциях и объектах игры.</p>'
	+ '<div class="img-medium-center">'
...
,
{
	title: 'Отзывы и предложения',
		description
:
	'<p>Хотите оставить отзыв или предложение? Нашли баг или ошибку?</p>'
	+ '<div class="img-small-center">'
...
,
{
	title: 'Пример кода',
		description
:
	'<p>Метод run() запускается системой, в нем вы можете изменять корабль.</p>'
...
,
{
	title: 'Горячие клавишы',
		description
:
	'<p>Есть несколько горячих клавиш, о которых нужно знать:</p>'
...
,
{
	title: 'Метод run(spaceCraft, world)',
		description
:
	'<p>В метод <b>run(spaceCraft, world)</b> передаются два параметра spaceCraft и world:</p>'
	+ '<div class="img-huge-center">'
...
,
{
	title: 'Объект spaceCraft',
		description
:
	'<p>С помощью данного объекта вы можете:</p>'
...
,
{
	title: 'Блоки корабля',
		description
:
	'<p>Корабль состоит из 3 основных блоков:</p>'
...
,
{
	title: 'Модули корабля',
		description
:
	'<p>Каждый блок содержит свои модули между которыми вы можете распределять энергию.</p>'
	+ '<div class="img-small-center">'
...
,
{
	title: 'Бонусы',
		description
:
	'<p>Из каждого корабля выпадают бонусы.</p>'
	+ '<div class="img-small-center">'
...
,
{
	title: 'Будущие изменения',
		description
:
	'<p>В текущий момент мы работаем над:</p>'
	+ '<div class="img-small-center">'
	+ '<img src="resources/assets/pages/saturn6white.png">'
	+ '</div>'
