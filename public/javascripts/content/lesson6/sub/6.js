	...
	return {
		...
		question:          {
			content: '<p>Думали это все? ' +
			         ...
			         'о неудачном расположении вопросов в этом тесте. Еще лет <strong>50-70</strong> и проблему решат.</p>' +
					 '<p>А пока, вы должны ответить на следующий вопрос: ' +
					 'каким будет результат выполнения выражения <strong class="under-label">156 % 67</strong>? ' +
		 	         'На ответ у вас есть 1 Янссенский год.</p>',
