...
function Pursuit () {
	...
	return {
		...
		'<li>Скорость должна изменяться постепенно (не более чем на 1PX/S за раз) и значение скорости не должно превышать 60PX/S. ' +
		'Иначе двигатель перегреется, и скорость уменьшится до 20;</li>' +
		'<li>Как только Вы приблизитесь на дистанцию менее 20PX до корабля противника активируйте устройство перехвата.</li>' +
		'</ul>',
		hint: '<ul>' +
