...
var slides = [
	{
		...
		+ '</div> '
		+ '<p>Мы расскажем вам о рабочем месте капитана, об основных функциях корабля и интерфейсе.</p>'
	...
	},
	{
		...
		subSlides:[
			...
			},
			{
				...
				+ '<img src="images/pages/astronaut6white.png" >'
				+ '</a>'
				+ '</div>'
		...
		subSlides:[
			{
				...
				+ '<img src="images/pages/spacecraft2white.png">'
				+ '</div> '
	...
	//	+ '<div class="img-huge-center">'
	//	+ '<img src="images/pages/code1.png" >'
	//	+ '</div> '
	...
	},
	{
		...
		subSlides:[
			...
			},
			{
				...
				+ '<p><b>Атаковать</b> врага, получать информацию о врагах в радиусе атаки.</p>'
		...
		subSlides:[
			{
				...
				+ '<div class="img-small-center">'
				+ '<img src="images/pages/glowtube.png">'
				+ '</div>'
