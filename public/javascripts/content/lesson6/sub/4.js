	...
	return {
		...
		question: {
			content: '<p>Несмотря на всю условность описываемых ситуаций, ' +
					 ...
					 '<p>Сначала, можно попробовать не давать ему приближаться к вашему кораблю.</p>' +
			...
			correctAnswerDescription: '<p>Этого будет мало против великого BBot\'a! Азазазазаза!</p>'
		},
		character:         [{
